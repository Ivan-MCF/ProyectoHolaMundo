<%-- 
    Document   : index
    Created on : 10/07/2020, 6:42:00 p. m.
    Author     : Cambalache
--%>
        ...
        <div class="page-container">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="frmCategoria">
                                        <div class="row mt-3">
                                            <div class="form-group col-sm-9 col-sm-12">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                ...
                                                <button type="button" id="btnBuscarNCategoria" class="btn btn-primary btn-xs"><i class="fa fa-plus-square"></i></button>
                                            </div>
                                    </form>
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-12">
                                            <nav>
                                                <ul id="paginationCtaegoria" class="pagination pagination-sm justify-content-end">
            ...
            <footer>
                <div class="footer-area">
                    <p>© Copyright 2020 <a href="https://colorlib.com/wp/">IvanLTorres</a>.</p>
                </div>
            </footer>
            <!-- footer area end-->
        </div>
